...
- (void)setup{
    ...
    _photoScrollView = [[UIScrollView alloc]initWithFrame:CGRectMake(0, 0, KWIDTH, 70)];
...
-(void)initlizerScrollView:(NSArray *)imgList{
    ...
    for(int i=0;i<imgList.count;i++){
        ...
        _photoItem = [[MKComposePhotosView alloc]initWithFrame:CGRectMake(10+ i * (ItemWidth + 5 ), 5, ItemWidth, ItemHeight)];
    ...
    if(imgList.count<MaxItemCount){
        ...
        [btnphoto setFrame:CGRectMake(2 + (ItemWidth + 5) * imgList.count, 7, 60, 57)];//
