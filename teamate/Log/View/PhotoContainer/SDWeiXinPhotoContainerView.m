...
- (void)setPicPathStringsArray:(NSArray *)picPathStringsArray
{
    ...
    if (_picPathStringsArray.count == 1) {
        ...
        [image sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@",_picPathStringsArray.firstObject]]];
    ...
    [_picPathStringsArray enumerateObjectsUsingBlock:^(NSString *  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        imageView.hidden = NO;
        NSString *imageStr = [NSString stringWithFormat:@"%@",_picPathStringsArray[idx]];
